...
public final class DatabaseContract {
    ...
    public static class DataEntry implements BaseColumns{
        ...
        public static final String TABLE_NAME3 = "customWorkoutList";
        ...
        public static final String SQL_CREATE_ENTRIES3 = "Create table " +
                DataEntry.TABLE_NAME3 + " (" + DataEntry._ID + " INTEGER PRIMARY KEY, " +
                DataEntry.COLUMN_NAME_NAME + " TEXT)";
